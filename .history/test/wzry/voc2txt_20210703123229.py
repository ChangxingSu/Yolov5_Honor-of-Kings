...
parser.add_argument('--data',required=True,type=str, help='input dataset path')
#数据集的划分，地址选择自己数据下的ImageSets/Main
# parser.add_argument('--txt_path', default='worktxt', type=str, help='output txt fold')
opt = parser.parse_args()

data_path = opt.data
xmlfilepath=data_path+'/Annotations'
txtsavepath = data_path+'/worktxt'
